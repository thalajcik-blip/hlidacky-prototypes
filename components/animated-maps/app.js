const maps = {
  ...
  croatia: {
    ...
    regions: [
      { id: 'zagrebacka', name: 'Zagrebačka', value: 8.00, delay: 250, x: 956, y: 450 },
      { id: 'krapinsko-zagorska', name: 'Krapinsko-zagorska', label: 'Krapinsko-\nzagorska', value: 7.40, delay: 0, x: 770, y: 220 },
      { id: 'sisacko-moslavacka', name: 'Sisačko-moslavačka', label: 'Sisačko-\nmoslavačka', value: 6.80, delay: 500, x: 951, y: 599 },
      { id: 'karlovacka', name: 'Karlovačka', value: 6.80, delay: 500, x: 677, y: 639 },
      { id: 'varazdinska', name: 'Varaždinska', value: 6.90, delay: 0, x: 946, y: 237 },
      { id: 'koprivnicko-krizevacka', name: 'Koprivničko-križevačka', label: 'Koprivničko-\nkriževačka', value: 5.60, delay: 250, x: 1128, y: 238 },
      { id: 'bjelovarsko-bilogorska', name: 'Bjelovarsko-bilogorska', label: 'Bjelovarsko-\nbilogorska', value: 5.40, delay: 500, x: 1123, y: 404 },
      { id: 'primorsko-goranska', name: 'Primorsko-goranska', label: 'Primorsko-\ngoranska', value: 8.40, delay: 750, x: 438, y: 554 },
      { id: 'licko-senjska', name: 'Ličko-senjska', value: 6.80, delay: 500, x: 600, y: 860 },
      { id: 'viroviticko-podravska', name: 'Virovitičko-podravska', label: 'Virovitičko-\npodravska', value: 5.60, delay: 750, x: 1325, y: 408 },
      { id: 'pozesko-slavonska', name: 'Požeško-slavonska', value: 6.10, delay: 750, x: 1364, y: 570 },
      { id: 'brodsko-posavska', name: 'Brodsko-posavska', value: 6.80, delay: 500, x: 1271, y: 692 },
      { id: 'zadarska', name: 'Zadarska', value: 8.00, delay: 250, x: 720, y: 1109 },
      { id: 'osjecko-baranjska', name: 'Osječko-baranjska', label: 'Osječko-\nbaranjska', value: 6.10, delay: 750, x: 1578, y: 501 },
      { id: 'sibensko-kninska', name: 'Šibensko-kninska', value: 6.80, delay: 500, x: 858, y: 1220 },
      { id: 'vukovarsko-srijemska', name: 'Vukovarsko-srijemska', label: 'Vukovarsko-\nsrijemska', value: 6.60, delay: 750, x: 1696, y: 669 },
      { id: 'splitsko-dalmatinska', name: 'Splitsko-dalmatinska', label: 'Splitsko-\ndalmatinska', value: 8.70, delay: 0, x: 1060, y: 1340 },
      { id: 'istarska', name: 'Istarska', value: 7.50, delay: 0, x: 190, y: 648 },
      { id: 'dubrovacko-neretvanska', name: 'Dubrovačko-neretvanska', label: 'Dubrovačko-\nneretvanska', value: 8.80, delay: 250, x: 1279, y: 1570 },
      { id: 'medimurska', name: 'Međimurska', value: 7.10, delay: 0, x: 946, y: 98 },
      { id: 'grad-zagreb', name: 'Grad Zagreb', label: 'Grad\nZagreb', value: 8.50, delay: 250, x: 817, y: 377 },
    ],
  },
}
